...
mongoose.connect('mongodb+srv://g00366442:Ajstar11@cluster0.fc4rsgr.mongodb.net/?retryWrites=true&w=majority');
...
app.put('/post', uploadMiddleware.single('file'), async (req, res) => {
  ...
  jwt.verify(token, secret, {}, async (err, info) => {
    ...
    await Post.findOneAndUpdate(
      { _id: id },
      { $set: { title, summary, content, cover: newPath || postDoc.cover } },
      { new: true }
    );
